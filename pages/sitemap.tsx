        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8 md:p-10">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div className="space-y-8">
                <section>
                  ...
                  <ul className="space-y-2">
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Home
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/about" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> About Us
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/blog" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Blog
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/booking" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                ...
                <section>
                  ...
                  <ul className="space-y-2">
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/mutual-funds" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Mutual Funds
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/insurance" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Insurance
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/health-insurance" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Health Insurance
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/loans" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Loans
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/loans/personal" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Personal Loans
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/loans/business" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
              ...
              <div className="space-y-8">
                <section>
                  ...
                  <ul className="space-y-2">
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/calculators/sip" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> SIP Calculator
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/calculators/emi" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> EMI Calculator
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/tax-saving" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                ...
                <section>
                  ...
                  <ul className="space-y-2">
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/privacy-policy" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Privacy Policy
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/terms-of-service" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Terms of Service
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/sitemap" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                ...
                <section>
                  ...
                  <ul className="space-y-2">
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/admin" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Admin Dashboard
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/admin/blogs" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
                        <ArrowRight size={14} className="mr-2 text-fintech-blue" /> Blog Management
                      </Link>
                    </li>
                    <li className="transition-all hover:translate-x-1">
                      <Link href="/admin/bookings" className="inline-flex items-center text-gray-600 hover:text-fintech-purple">
            ...
            <div className="mt-12 pt-4 border-t border-gray-100">
              <Link href="/" className="inline-flex items-center text-fintech-blue hover:text-fintech-purple transition-colors">
