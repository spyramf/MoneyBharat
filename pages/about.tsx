...
const AboutUs = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg">
              <div className="bg-gradient-to-r from-accent to-secondary h-64 flex items-center justify-center">
          ...
          <div className="relative">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-8">
                <div className="bg-destructive w-6 h-6 rounded-full border-4 border-background shadow-md"></div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                <div className="md:text-right md:pr-12">
                  <h3 className="text-lg font-bold text-accent-foreground">2018</h3>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-8">
                <div className="bg-fintech-purple w-6 h-6 rounded-full border-4 border-background shadow-md"></div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                <div className="md:text-right md:pr-12 md:hidden lg:block lg:invisible"></div>
                <div className="md:pl-12">
                  <h3 className="text-lg font-bold text-accent-foreground">2019</h3>
                  <h4 className="text-xl font-bold mb-2">AMFI Registration</h4>
                  <p className="text-muted-foreground">Received official AMFI registration and partnered with first 10 AMCs.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-8">
                <div className="bg-primary w-6 h-6 rounded-full border-4 border-background shadow-md"></div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                <div className="md:text-right md:pr-12">
                  <h3 className="text-lg font-bold text-accent-foreground">2020</h3>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                <div className="md:text-right md:pr-12 md:hidden lg:block lg:invisible"></div>
                <div className="md:pl-12">
                  <h3 className="text-lg font-bold text-accent-foreground">2021</h3>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-8">
                <div className="bg-secondary w-6 h-6 rounded-full border-4 border-background shadow-md"></div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                <div className="md:text-right md:pr-12">
                  <h3 className="text-lg font-bold text-accent-foreground">2022</h3>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="md:text-right md:pr-12 md:hidden lg:block lg:invisible"></div>
                <div className="md:pl-12">
                  <h3 className="text-lg font-bold text-accent-foreground">2023</h3>
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 bg-gradient-to-r from-accent to-secondary text-white">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
