        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="glass-card p-6 border">
              <div className="w-14 h-14 bg-gradient-to-r from-fintech-green to-fintech-blue rounded-xl mb-4 flex items-center justify-center">
        ...
        <div className="container mx-auto">
          ...
          <div className="">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex">
                <div className="w-12 h-12 bg-fintech-purple/10 rounded-full flex-shrink-0 flex items-center justify-center mr-4">
                  <Hospital className="h-6 w-6 text-fintech-green" />
                </div>
                <div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <div className="w-12 h-12 bg-fintech-purple/10 rounded-full flex items-center justify-center mb-4">
                  <Ambulance className="h-6 w-6 text-fintech-green" />
                </div>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <div className="w-12 h-12 bg-fintech-purple/10 rounded-full flex items-center justify-center mb-4">
                  <User className="h-6 w-6 text-fintech-green" />
                </div>
