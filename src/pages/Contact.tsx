  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        ...
        description="Contact Money Bharat Finance for personalized financial advice on mutual funds, insurance, and loans. Call +91 9970735694 or email contact@moneybharatfinance.com. Free consultation available."
