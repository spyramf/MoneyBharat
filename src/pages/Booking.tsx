          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-gray-600">
                Schedule a free consultation with our financial experts to discuss your financial goals and create a
                personalized plan.
              </p>
            </div>
              ...
              <Card className="py-10">
                <CardContent className="flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Thank you for booking a consultation with Money Bharat. We will confirm your appointment shortly via
                    email.
                  </p>
