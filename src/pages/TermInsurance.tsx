  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEOHead
        ...
        description="Compare and buy best term insurance online with high coverage at lowest premiums. Get term life insurance from ₹25 Lakhs to ₹2 Crore. Free premium calculator, instant policy issuance. Tax benefits under Section 80C & 10(10D). Protection for your family's future."
        keywords="term insurance calculator, best term insurance India, term life insurance online, term insurance premium calculator, life insurance plans, term insurance policy, online term insurance, term insurance comparison, life cover plans"
      />
