        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="mb-6 flex justify-center">
                <Avatar className="w-32 h-32 border-4 border-fintech-purple/20">
                  <AvatarFallback className="bg-fintech-deep-purple text-white text-2xl">RK</AvatarFallback>
                </Avatar>
              </div>
              <h3 className="font-bold text-xl mb-1">Rajesh Kumar</h3>
              <p className="text-fintech-orange font-medium mb-3">Founder & CEO</p>
              <p className="text-gray-600">15+ years of experience in financial services. Former VP at HDFC Bank.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="mb-6 flex justify-center">
                <Avatar className="w-32 h-32 border-4 border-fintech-purple/20">
                  <AvatarFallback className="bg-fintech-blue text-white text-2xl">AV</AvatarFallback>
                </Avatar>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="mb-6 flex justify-center">
                <Avatar className="w-32 h-32 border-4 border-fintech-purple/20">
                  <AvatarFallback className="bg-fintech-orange text-white text-2xl">VS</AvatarFallback>
                </Avatar>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="mb-6 flex justify-center">
                <Avatar className="w-32 h-32 border-4 border-fintech-purple/20">
                  <AvatarFallback className="bg-fintech-purple text-white text-2xl">PS</AvatarFallback>
                </Avatar>
              </div>
              ...
              <p className="text-gray-600">Customer service expert focused on building seamless financial journeys.</p>
            </div>
          </div>
        </div>
      </section>
