    ...
    <div className="space-y-6">
        ...
        <CardContent className="text-center">
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-center gap-2 text-yellow-300">
              ...
              <span className="font-medium">Monday - Saturday: 9:00 AM - 7:00 PM</span>
            </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-medium text-fintech-green mb-2">{method.value}</p>
                  <p className="text-sm text-gray-500 mb-3">{method.available}</p>
      ...
      <Card className="shadow-lg bg-gradient-to-r from-purple-50 to-blue-50 border-purple-200">
        <CardContent className="p-6 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Video Consultation Available</h3>
