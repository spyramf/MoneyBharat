        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="w-full md:w-1/2">
            <div className="relative">
              ...
              <div className="absolute -top-6 right-4 md:right-10 w-24 h-24 glass-card rounded-lg shadow-lg p-2 flex flex-col items-center justify-center">
              ...
              <div className="absolute -bottom-4 -left-4 p-3 glass-card rounded-lg shadow-lg">
                <div className="flex items-center gap-2">
