...
const TermCTA = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-r from-fintech-purple via-blue-600 to-blue-500 text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl opacity-90 mb-10 max-w-2xl mx-auto leading-relaxed">
            Get comprehensive term insurance coverage at affordable premiums. Don't leave your family's future to chance.
          </p>
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <Button size="lg" variant="outline" className="border-2 border-white text-white shadow-lg transition-all duration-300 bg-fintech-purple">
