            ...
            {claimSteps.map((step, index) => (
              <div key={step.id} className="relative flex flex-col md:flex-row mb-8 md:mb-12">
                <div className="flex-none md:w-20">
                  <div className="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-lg z-10 relative mx-auto">
                    {step.number}
                  </div>
                </div>
                ...
                {index < claimSteps.length - 1 && (
                  <div className="hidden md:flex absolute left-[40px] top-[56px] text-blue-600">
