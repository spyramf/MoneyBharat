...
const MoneyBharatBenefits = ({ benefits }: MoneyBharatBenefitsProps) => {
  return (
      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <p className="text-lg text-gray-600">
            Why thousands of customers choose Money Bharat for their insurance needs
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {benefits.map((benefit, index) => (
            <Card key={index} className="h-full transition-all duration-200 hover:shadow-lg hover:-translate-y-1">
