...
>
  ...
  <TrendingUp className="ml-2 h-5 w-5" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <motion.div className="flex items-center justify-center gap-3 p-4 bg-white/80 backdrop-blur-sm rounded-lg shadow-sm" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            delay: 0.4
              ...
              <div>
                <p className="font-semibold text-gray-900">₹100 Min SIP</p>
