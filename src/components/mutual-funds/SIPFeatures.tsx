...
const SIPFeatures = ({
  ...
  return <section className="py-16 px-4 md:px-8 bg-gradient-to-br from-white to-blue-50">
      <div className="container mx-0">
        <div className="max-w-5xl mx-auto">
          ...
          }} className="bg-white border border-gray-100 rounded-xl p-6 shadow-md hover:shadow-lg hover:border-fintech-purple/30 transition-all duration-300 animate-fade-in px-0 py-[29px] mx-0">
