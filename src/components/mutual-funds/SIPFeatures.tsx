...
const SIPFeatures = ({ features }: SipFeaturesProps) => {
  ...
  return (
    <section className="py-20 px-4 md:px-8 bg-gradient-to-br from-white via-blue-50/30 to-green-50/30">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-3xl font-bold text-fintech-green mb-1">2M+</div>
              <div className="text-sm text-gray-600">Active Investors</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-fintech-orange mb-1">₹5000Cr+</div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-fintech-purple mb-1">0%</div>
        ...
        >
          {enhancedFeatures.map((feature, index) => (
            <motion.div key={index} variants={itemVariants}>
              <Card className={`h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-0 ${
                feature.highlight 
                  ? 'bg-gradient-to-br from-fintech-green/5 to-fintech-orange/5 ring-2 ring-fintech-green/20' 
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between mb-4">
                    <div className="relative">
                      {feature.icon}
                      {feature.highlight && (
                        <div className="absolute -top-1 -right-1 w-3 h-3 bg-fintech-orange rounded-full animate-pulse"></div>
                      )}
                    </div>
                    {feature.stats && (
        ...
        <motion.div 
          className="bg-gradient-to-r from-fintech-green/10 to-fintech-orange/10 rounded-2xl p-8 mb-12"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
