...
const LoanHero = ({ 
  ...
  return (
    <section className={`relative overflow-hidden pt-24 pb-16 bg-gradient-to-br from-gray-50 via-white to-blue-50 ${className}`}>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link to="/booking">
              <Button className={`bg-gradient-to-r ${gradientFrom} ${gradientTo} hover:opacity-90 text-white px-8 py-4 text-lg`}>
                {primaryButtonText}
