-- Add sample blog posts (avoiding category conflicts)
...
(
  ...
  (SELECT id FROM public.blog_categories WHERE slug = 'tax-saving' LIMIT 1),
...
(
  ...
  (SELECT id FROM public.blog_categories WHERE slug = 'insurance-guide' LIMIT 1),
  (SELECT id FROM public.blog_authors LIMIT 1),
...
(
  ...
  (SELECT id FROM public.blog_categories WHERE slug = 'mutual-funds-guide' LIMIT 1),
  (SELECT id FROM public.blog_authors LIMIT 1),
