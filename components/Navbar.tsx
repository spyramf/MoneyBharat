...
const Navbar = () => {
  ...
  return <nav className={cn('sticky top-0 z-50 transition-all duration-300 py-4', scrolled ? 'bg-background/95 backdrop-blur-md shadow-md' : 'bg-background/80 backdrop-blur-sm shadow-sm')}>
