...
const MutualFundSection = () => {
  ...
  return (
    <motion.section
      className="py-16 bg-background md:py-[20px]"
      initial="hidden"
      whileInView="visible"
    ...
    >
      <div className="container mx-auto px-4">
        <motion.div className="text-center max-w-3xl mx-auto mb-16" variants={itemVariants}>
          ...
          <p className="text-muted-foreground">Grow your wealth with our curated selection of top-performing mutual funds</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div variants={itemVariants}>
            <Card className="border-0 shadow-md hover:shadow-xl transition-shadow duration-300 hover:-translate-y-1">
              <CardHeader className="pb-4">
                <div className="w-12 h-12 flex items-center justify-center bg-accent rounded-full mb-4">
