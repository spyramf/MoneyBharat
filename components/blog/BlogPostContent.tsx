      ...
      {post.featuredImage && (
        <div className="mb-12 rounded-2xl overflow-hidden shadow-lg">
          <img
            ...
            alt={
              post.title + " - " + post.category + " - " + (post?.tags?.[0] || "Money Bharat") + " - Money Bharat Blog"
            }
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                {post.author.role} at Money Bharat with extensive experience in Indian financial markets. Passionate
                about making finance accessible to everyone through clear, actionable insights and expert guidance on
